...
//! in their respective crates (e.g., `resin-audio::optimize`).
//!
//! # Example
//!
//! ```ignore
//! use rhizome_resin_core::optimize::{Optimizer, OptimizerPipeline};
//!
...
///
/// ```ignore
/// use rhizome_resin_core::optimize::OptimizerPipeline;
///
/// let mut pipeline = OptimizerPipeline::new()
///     .add(ConstantFolder)
